...
public class UserController {
	...
	public ModelAndView register() {
		ModelAndView mav= new ModelAndView("Q4/Registration");
		return mav;
	}
	...
	public ModelAndView login(@ModelAttribute("user") User user) {
		...
		ModelAndView mav= new ModelAndView("Q4/Login");
		return mav;
	}
	...
	public ModelAndView verify(@ModelAttribute("user") User user) {
		...
		if(user.getUsername().compareTo(this.user.getUsername())==0 && user.getPassword().compareTo(this.user.getPassword())==0)
			mav= new ModelAndView("Q4/Success");
		else
			mav= new ModelAndView("Q4/Error");
